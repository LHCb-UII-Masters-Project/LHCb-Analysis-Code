...
bs_pt= array('f', [0])
tree.Branch('bs_pt', bs_pt, 'bs_pt/F')
pi2_pt= array('f', [0])
...
Kaon_model = [eff_model(eff_dfs[0]), eff_model(eff_dfs[1]), eff_model(eff_dfs[2]), eff_model(eff_dfs[3]), eff_model(eff_dfs[4]) if timing == 300 else None]
