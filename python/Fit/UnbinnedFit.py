...
parser.add_argument("particle", type=str, help="Provide the particle for fitting mass distribution")
parser.add_argument("fit_range", type=float, help="sigma for fit range")
