#---------------------------------Imports------------------------------------------
import ROOT
from Variables.ChebyChev import variables, fit_initial_guess_tree
...
bkg_coef1 = ROOT.RooRealVar("bkg_coef1", "Chebychev coefficient 1", variables['bkg_coef1']['value'], variables['bkg_coef1']['min'], variables['bkg_coef1']['max'])
bkg_coef2 = ROOT.RooRealVar("bkg_coef2", "Chebychev coefficient 2", variables['bkg_coef2']['value'], variables['bkg_coef2']['min'], variables['bkg_coef2']['max'])
bkg = ROOT.RooChebychev("bkg", "Chebychev Background", x, ROOT.RooArgList(bkg_coef1, bkg_coef2))
...
bkg_coef1_val = ROOT.std.vector('float')()
bkg_coef1_err_sym  = ROOT.std.vector('float')()
bkg_coef2_val = ROOT.std.vector('float')()
bkg_coef2_err_sym  = ROOT.std.vector('float')()
...
bkg_coef1_val.push_back(bkg_coef1.getVal())
bkg_coef1_err_sym.push_back(bkg_coef1.getError())
bkg_coef2_val.push_back(bkg_coef2.getVal())
bkg_coef2_err_sym.push_back(bkg_coef2.getError())
...
tree.Branch("bkg_coef1", bkg_coef1_val)
tree.Branch("bkg_coef1_error_sym", bkg_coef1_err_sym)
tree.Branch("bkg_coef2", bkg_coef2_val)
tree.Branch("bkg_coef2_error_sym", bkg_coef2_err_sym)
